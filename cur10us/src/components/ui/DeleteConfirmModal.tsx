...
const DeleteConfirmModal = ({ open, onClose, onConfirm, itemName }: DeleteConfirmModalProps) => {
    ...
    >
      <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-xl border border-zinc-200 dark:border-zinc-800 w-full max-w-sm animate-in fade-in zoom-in-95 duration-200">
        <div className="flex items-center justify-between p-4 border-b border-zinc-100 dark:border-zinc-800">
          <h2 className="text-lg font-bold text-rose-600">Confirmar exclusão</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-4 sm:p-6">
          <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-6">
            Tem certeza que deseja excluir <strong className="text-zinc-900 dark:text-zinc-100">{itemName}</strong>? Esta ação não pode ser desfeita.
          </p>
