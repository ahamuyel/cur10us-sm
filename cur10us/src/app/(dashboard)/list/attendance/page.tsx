...
const statusColor = {
  Presente: "bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400",
  Ausente: "bg-rose-50 dark:bg-rose-950/40 text-rose-600 dark:text-rose-400",
  Atrasado: "bg-amber-50 dark:bg-amber-950/40 text-amber-600 dark:text-amber-400",
}
