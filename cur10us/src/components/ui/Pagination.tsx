    ...
    return (
        <div className="p-4 flex items-center justify-between text-gray-500">
            ...
            <div className="flex items-center gap-2 text-sm">
                <button className="px-2 rounded-sm bg-[#73f3ff]">1</button>
                <button className="px-2 rounded-sm bg-[#f3ffff]">2</button>
                <button className="px-2 rounded-sm bg-[#f3ffff]">3</button>
                <button className="px-2 rounded-sm bg-[#f3ffff]">4</button>
                ...
                <button className="px-2 rounded-sm bg-[#f3ffff]">10</button>
            </div>
