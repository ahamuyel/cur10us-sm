...
const moreItems = [
  { label: "Responsáveis", href: "/list/parents" },
  { label: "Frequência", href: "/admin" },
  { label: "Mensagens", href: "/admin" },
  { label: "Avisos", href: "/admin" },
            ...
            <div className="grid grid-cols-2 gap-2">
              {moreItems.map((item) => (
                <Link
                  ...
                  className="px-3 py-2.5 rounded-xl text-sm font-medium text-zinc-700 dark:text-zinc-300 hover:bg-indigo-50 dark:hover:bg-indigo-950/50 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors text-center"
                >
                  {item.label}
                </Link>
              ))}
