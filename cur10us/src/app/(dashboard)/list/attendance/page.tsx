...
import { SlidersHorizontal, ArrowUpDown, Plus, Loader2 } from "lucide-react"
...
const AttendanceListPage = () => {
  ...
  const { data, totalPages, page, search, setSearch, setPage, loading, refetch } = useEntityList<Attendance>({ endpoint: "/api/attendance", limit: 5 })
